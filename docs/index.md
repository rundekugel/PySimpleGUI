...
|       Tuple[Tuple[str,str]]        |        file_types        | List of extensions to show using wildcards. All files (the default) = (("ALL Files", "*.*"),). There is a difference between (("Textfile and Exe",("txt","exe"))) and (("Textfile",("txt")),("Executeable","exe")) |
